        ...
        <div className="py-6">
            ...
            <div className="w-4/5 mx-auto flex flex-col gap-10 lg:flex-row lg:gap-0 items-center justify-between">
                ...
                <div className="flex flex-col items-center justify-center gap-1">
                    <img className="w-20 rounded-full" src="https://i.ibb.co/2NZJyW9/3d7581-6a6d532daaa743f08b822f674fd45f29-mv2-1.png" alt="" />
               ...
               <div className="avatar">
                ...
                <NavLink to='/login' className={({isActive})=>`${isActive&&`  bg-[#220032] text-white `} py-2 px-5 rounded-md font-bold `}>Login</NavLink>
